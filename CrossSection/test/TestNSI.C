...
int main()
{
	...
	NuElasticCS nutr2;
	NuElasticCS nutl2;
	nutr.SetupNSI(0,0,0,0.2);
	nutl.SetupNSI(0,0,0.2,0);
	nutr2.SetupNSI(0,0,0,-0.2);
	nutl2.SetupNSI(0,0,-0.2,0);
	TCanvas c1;
	...
	for(int i=0; i<1000; i++)
	{
		...
		graph->SetPoint(i, Te, nu.dsdTe(0.862,Te,2,0));
		graph2->SetPoint(i, Te, nutr.dsdTe(0.862,Te,2,0));
		graph3->SetPoint(i, Te, nutl.dsdTe(0.862,Te,2,0));
		graph4->SetPoint(i, Te, nutr2.dsdTe(0.862,Te,2,0));
		graph5->SetPoint(i, Te, nutl2.dsdTe(0.862,Te,2,0));
	}
	...
	leg->AddEntry(graph2, "#varepsilon_{#tauR}=0.2", "l");
	leg->AddEntry(graph4, "#varepsilon_{#tauR}=-0.2", "l");
	leg->AddEntry(graph3, "#varepsilon_{#tauL}=0.2", "l");
	leg->AddEntry(graph5, "#varepsilon_{#tauL}=-0.2", "l");
	leg->Draw("same");
	//c1.SaveAs("test.pdf");
	c1.SaveAs("test.root");
	return 0;
