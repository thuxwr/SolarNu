...
int main()
{
	...
	/* SurvProb = e0 + e1/e2 * (exp(e2(E-10)) -1 ) */
	minuit.mnparm(0, "e0", 0.336, 0.023, 0, 0, ierflg);
	minuit.mnparm(1, "e1", 0, 0.0051, 0, 0, ierflg);
	minuit.mnparm(2, "e2", -0.3, 0.0034, 0, 0, ierflg);
...
void probfcn(int &npar, double* gin, double &f, double* par, int iflag)
{
	TF1* func = new TF1("SurvProb", "[0]+[1]/[2] * (exp([2]-10)-1)", 0, 20);
